...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/collection.png
  AssetGenImage get collection =>
      const AssetGenImage('assets/images/collection.png');

  /// File path: assets/images/person.png
  AssetGenImage get person => const AssetGenImage('assets/images/person.png');

  /// File path: assets/images/trending.png
  AssetGenImage get trending =>
      const AssetGenImage('assets/images/trending.png');

  /// List of all assets
  List<AssetGenImage> get values =>
      [banner1, banner2, banner3, collection, person, trending];
}
